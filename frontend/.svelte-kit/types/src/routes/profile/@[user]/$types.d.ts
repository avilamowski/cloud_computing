...
type LayoutRouteId = RouteId | "/profile/@[user]" | "/profile/@[user]/favorites"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/profile/@[user]/+layout.server.js').load>>>>>>;
