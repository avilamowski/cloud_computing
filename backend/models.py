...
class Comment(Base):
    ...
    publication_id = Column(
        String, ForeignKey("publications.publication_id"), nullable=False
    )
...
class Publication(Base):
    ...
    comments = relationship(
        "Comment", back_populates="publication", cascade="all, delete"
    )
    tags = relationship(
        "Tag", secondary=publication_tag_table, back_populates="publications"
    )
